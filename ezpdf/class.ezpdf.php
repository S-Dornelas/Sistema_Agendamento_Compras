...
// note that the user will have had to make a font selection already or this will not // produce a valid pdf file.
	...
	,'showHeadings'=>1,'textCol'=>array(0,0,0),'width'=>0,'maxWidth'=>0,'cols'=>array(),'minRowSpace'=>-100,'rowGap'=>2,'colGap'=>8
...
function ezProcessText($text){
  ...
  // purposes
  $search = array('<u>','<U>','</u>','</U>', '<red>', '<RED>', '</red>', '</RED>', '<green>', '</green>', '<greenlime>', '</greenlime>', '<blue>', '</blue>', '<cyan>', '</cyan>', '<gold>', '</gold>', '<purple>', '</purple>', '<sienna>', '</sienna>', '<salmon>', '</salmon>');
  $replace = array('<c:uline>','<c:uline>','</c:uline>','</c:uline>', '<c:red>', '<c:red>', '</c:red>', '</c:red>', '<c:green>', '</c:green>', '<c:greenlime>', '</c:greenlime>', '<c:blue>', '</c:blue>', '<c:cyan>', '</c:cyan>', '<c:gold>', '</c:gold>', '<c:purple>', '</c:purple>', '<c:sienna>', '</c:sienna>', '<c:salmon>', '</c:salmon>');
  return str_replace($search,$replace,$text);
}

function ezSetColor($color,$function="setColor"){
	switch (strtoupper($color)){
		case'LIGHTPINK': {$this->$function(1,0.71372549,0.756862745); break;}
		case'PINK': {$this->$function(1,0.752941176,0.796078431); break;}
		case'CRIMSON': {$this->$function(0.862745098,0.078431373,0.235294118); break;}
		case'LAVENDERBLUSH': {$this->$function(1,0.941176471,0.960784314); break;}
		case'PALEVIOLETRED': {$this->$function(0.858823529,0.439215686,0.576470588); break;}
		case'HOTPINK': {$this->$function(1,0.411764706,0.705882353); break;}
		case'DEEPPINK': {$this->$function(1,0.078431373,0.576470588); break;}
		case'MEDIUMVIOLETRED': {$this->$function(0.780392157,0.082352941,0.521568627); break;}
		case'ORCHID': {$this->$function(0.854901961,0.439215686,0.839215686); break;}
		case'THISTLE': {$this->$function(0.847058824,0.749019608,0.847058824); break;}
		case'PLUM': {$this->$function(0.866666667,0.62745098,0.866666667); break;}
		case'VIOLET': {$this->$function(0.933333333,0.509803922,0.933333333); break;}
		case'FUCHSIA': {$this->$function(1,0,1); break;}
		case'DARKMAGENTA': {$this->$function(0.545098039,0,0.545098039); break;}
		case'PURPLE': {$this->$function(0.501960784,0,0.501960784); break;}
		case'MEDIUMORCHID': {$this->$function(0.729411765,0.333333333,0.82745098); break;}
		case'DARKVIOLET': {$this->$function(0.580392157,0,0.82745098); break;}
		case'DARKORCHID': {$this->$function(0.6,0.196078431,0.8); break;}
		case'INDIGO': {$this->$function(0.294117647,0,0.509803922); break;}
		case'BLUEVIOLET': {$this->$function(0.541176471,0.168627451,0.88627451); break;}
		case'MEDIUMPURPLE': {$this->$function(0.576470588,0.439215686,0.858823529); break;}
		case'MEDIUMSLATEBLUE': {$this->$function(0.482352941,0.407843137,0.933333333); break;}
		case'SLATEBLUE': {$this->$function(0.415686275,0.352941176,0.803921569); break;}
		case'DARKSLATEBLUE': {$this->$function(0.282352941,0.239215686,0.545098039); break;}
		case'GHOSTWHITE': {$this->$function(0.97254902,0.97254902,1); break;}
		case'LAVENDER': {$this->$function(0.901960784,0.901960784,0.980392157); break;}
		case'BLUE': {$this->$function(0,0,1); break;}
		case'MEDIUMBLUE': {$this->$function(0,0,0.803921569); break;}
		case'DARKBLUE': {$this->$function(0,0,0.545098039); break;}
		case'NAVY': {$this->$function(0,0,0.501960784); break;}
		case'MIDNIGHTBLUE': {$this->$function(0.098039216,0.098039216,0.439215686); break;}
		case'ROYALBLUE': {$this->$function(0.254901961,0.411764706,0.882352941); break;}
		case'CORNFLOWERBLUE': {$this->$function(0.392156863,0.584313725,0.929411765); break;}
		case'LIGHTSTEELBLUE': {$this->$function(0.690196078,0.768627451,0.870588235); break;}
		case'LIGHTSLATEGRAY': {$this->$function(0.466666667,0.533333333,0.6); break;}
		case'SLATEGRAY': {$this->$function(0.439215686,0.501960784,0.564705882); break;}
		case'DODGERBLUE': {$this->$function(0.117647059,0.564705882,1); break;}
		case'ALICEBLUE': {$this->$function(0.941176471,0.97254902,1); break;}
		case'STEELBLUE': {$this->$function(0.274509804,0.509803922,0.705882353); break;}
		case'LIGHTSKYBLUE': {$this->$function(0.529411765,0.807843137,0.980392157); break;}
		case'SKYBLUE': {$this->$function(0.529411765,0.807843137,0.921568627); break;}
		case'DEEPSKYBLUE': {$this->$function(0,0.749019608,1); break;}
		case'LIGHTBLUE': {$this->$function(0.678431373,0.847058824,0.901960784); break;}
		case'POWDERBLUE': {$this->$function(0.690196078,0.878431373,0.901960784); break;}
		case'CADETBLUE': {$this->$function(0.37254902,0.619607843,0.62745098); break;}
		case'DARKTURQUOISE': {$this->$function(0,0.807843137,0.819607843); break;}
		case'AZURE': {$this->$function(0.941176471,1,1); break;}
		case'LIGHTCYAN': {$this->$function(0.878431373,1,1); break;}
		case'PALETURQUOISE': {$this->$function(0.68627451,0.933333333,0.933333333); break;}
		case'AQUA': {$this->$function(0,1,1); break;}
		case'DARKCYAN': {$this->$function(0,0.545098039,0.545098039); break;}
		case'TEAL': {$this->$function(0,0.501960784,0.501960784); break;}
		case'DARKSLATEGRAY': {$this->$function(0.184313725,0.309803922,0.309803922); break;}
		case'MEDIUMTURQUOISE': {$this->$function(0.282352941,0.819607843,0.8); break;}
		case'LIGHTSEAGREEN': {$this->$function(0.125490196,0.698039216,0.666666667); break;}
		case'TURQUOISE': {$this->$function(0.250980392,0.878431373,0.815686275); break;}
		case'AQUAMARINE': {$this->$function(0.498039216,1,0.831372549); break;}
		case'MEDIUMAQUAMARINE': {$this->$function(0.4,0.803921569,0.666666667); break;}
		case'MEDIUMSPRINGGREEN': {$this->$function(0,0.980392157,0.603921569); break;}
		case'MINTCREAM': {$this->$function(0.960784314,1,0.980392157); break;}
		case'SPRINGGREEN': {$this->$function(0,1,0.498039216); break;}
		case'MEDIUMSEAGREEN': {$this->$function(0.235294118,0.701960784,0.443137255); break;}
		case'SEAGREEN': {$this->$function(0.180392157,0.545098039,0.341176471); break;}
		case'HONEYDEW': {$this->$function(0.941176471,1,0.941176471); break;}
		case'DARKSEAGREEN': {$this->$function(0.560784314,0.737254902,0.560784314); break;}
		case'PALEGREEN': {$this->$function(0.596078431,0.984313725,0.596078431); break;}
		case'LIGHTGREEN': {$this->$function(0.564705882,0.933333333,0.564705882); break;}
		case'LIMEGREEN': {$this->$function(0.196078431,0.803921569,0.196078431); break;}
		case'LIME': {$this->$function(0,1,0); break;}
		case'FORESTGREEN': {$this->$function(0.133333333,0.545098039,0.133333333); break;}
		case'GREEN': {$this->$function(0,0.501960784,0); break;}
		case'DARKGREEN': {$this->$function(0,0.392156863,0); break;}
		case'LAWNGREEN': {$this->$function(0.48627451,0.988235294,0); break;}
		case'CHARTREUSE': {$this->$function(0.498039216,1,0); break;}
		case'GREENYELLOW': {$this->$function(0.678431373,1,0.184313725); break;}
		case'DARKOLIVEGREEN': {$this->$function(0.333333333,0.419607843,0.184313725); break;}
		case'YELLOWGREEN': {$this->$function(0.603921569,0.803921569,0.196078431); break;}
		case'OLIVEDRAB': {$this->$function(0.419607843,0.556862745,0.137254902); break;}
		case'IVORY': {$this->$function(1,1,0.941176471); break;}
		case'BEIGE': {$this->$function(0.960784314,0.960784314,0.862745098); break;}
		case'LIGHTYELLOW': {$this->$function(1,1,0.878431373); break;}
		case'LIGHTGOLDENRODYELLOW': {$this->$function(0.980392157,0.980392157,0.823529412); break;}
		case'YELLOW': {$this->$function(1,1,0); break;}
		case'OLIVE': {$this->$function(0.501960784,0.501960784,0); break;}
		case'DARKKHAKI': {$this->$function(0.741176471,0.717647059,0.419607843); break;}
		case'PALEGOLDENROD': {$this->$function(0.933333333,0.909803922,0.666666667); break;}
		case'LEMONCHIFFON': {$this->$function(1,0.980392157,0.803921569); break;}
		case'KHAKI': {$this->$function(0.941176471,0.901960784,0.549019608); break;}
		case'GOLD': {$this->$function(1,0.843137255,0); break;}
		case'CORNSILK': {$this->$function(1,0.97254902,0.862745098); break;}
		case'GOLDENROD': {$this->$function(0.854901961,0.647058824,0.125490196); break;}
		case'DARKGOLDENROD': {$this->$function(0.721568627,0.525490196,0.043137255); break;}
		case'FLORALWHITE': {$this->$function(1,0.980392157,0.941176471); break;}
		case'OLDLACE': {$this->$function(0.992156863,0.960784314,0.901960784); break;}
		case'WHEAT': {$this->$function(0.960784314,0.870588235,0.701960784); break;}
		case'ORANGE': {$this->$function(1,0.647058824,0); break;}
		case'MOCCASIN': {$this->$function(1,0.894117647,0.709803922); break;}
		case'PAPAYAWHIP': {$this->$function(1,0.937254902,0.835294118); break;}
		case'BLANCHEDALMOND': {$this->$function(1,0.921568627,0.803921569); break;}
		case'NAVAJOWHITE': {$this->$function(1,0.870588235,0.678431373); break;}
		case'ANTIQUEWHITE': {$this->$function(0.980392157,0.921568627,0.843137255); break;}
		case'TAN': {$this->$function(0.823529412,0.705882353,0.549019608); break;}
		case'BURLYWOOD': {$this->$function(0.870588235,0.721568627,0.529411765); break;}
		case'DARKORANGE': {$this->$function(1,0.549019608,0); break;}
		case'BISQUE': {$this->$function(1,0.894117647,0.768627451); break;}
		case'LINEN': {$this->$function(0.980392157,0.941176471,0.901960784); break;}
		case'PERU': {$this->$function(0.803921569,0.521568627,0.247058824); break;}
		case'PEACHPUFF': {$this->$function(1,0.854901961,0.725490196); break;}
		case'SANDYBROWN': {$this->$function(0.956862745,0.643137255,0.376470588); break;}
		case'CHOCOLATE': {$this->$function(0.823529412,0.411764706,0.117647059); break;}
		case'SADDLEBROWN': {$this->$function(0.545098039,0.270588235,0.074509804); break;}
		case'SEASHELL': {$this->$function(1,0.960784314,0.933333333); break;}
		case'SIENNA': {$this->$function(0.62745098,0.321568627,0.176470588); break;}
		case'LIGHTSALMON': {$this->$function(1,0.62745098,0.478431373); break;}
		case'CORAL': {$this->$function(1,0.498039216,0.31372549); break;}
		case'ORANGERED': {$this->$function(1,0.270588235,0); break;}
		case'DARKSALMON': {$this->$function(0.91372549,0.588235294,0.478431373); break;}
		case'TOMATO': {$this->$function(1,0.388235294,0.278431373); break;}
		case'SALMON': {$this->$function(0.980392157,0.501960784,0.447058824); break;}
		case'MISTYROSE': {$this->$function(1,0.894117647,0.882352941); break;}
		case'LIGHTCORAL': {$this->$function(0.941176471,0.501960784,0.501960784); break;}
		case'SNOW': {$this->$function(1,0.980392157,0.980392157); break;}
		case'ROSYBROWN': {$this->$function(0.737254902,0.560784314,0.560784314); break;}
		case'INDIANRED': {$this->$function(0.803921569,0.360784314,0.360784314); break;}
		case'RED': {$this->$function(1,0,0); break;}
		case'BROWN': {$this->$function(0.647058824,0.164705882,0.164705882); break;}
		case'FIREBRICK': {$this->$function(0.698039216,0.133333333,0.133333333); break;}
		case'DARKRED': {$this->$function(0.545098039,0,0); break;}
		case'MAROON': {$this->$function(0.501960784,0,0); break;}
		case'WHITE': {$this->$function(1,1,1); break;}
		case'WHITESMOKE': {$this->$function(0.960784314,0.960784314,0.960784314); break;}
		case'GAINSBORO': {$this->$function(0.862745098,0.862745098,0.862745098); break;}
		case'LIGHTGREY': {$this->$function(0.82745098,0.82745098,0.82745098); break;}
		case'SILVER': {$this->$function(0.752941176,0.752941176,0.752941176); break;}
		case'DARKGRAY': {$this->$function(0.662745098,0.662745098,0.662745098); break;}
		case'GRAY': {$this->$function(0.501960784,0.501960784,0.501960784); break;}
		case'DIMGRAY': {$this->$function(0.411764706,0.411764706,0.411764706); break;}
		case'BLACK': default: {$this->$function(0,0,0); break;}
	}
}
...
function gold($info){
	switch($info['status']){
		...
		case 'sol':
			//el comienzo de la fuente pintada de rojo
			$this->saveState();
			$this->setColor(1,0.84,0);
			$this->setStrokeColor(1,0.84,0);
			break;
		case 'end':
		case 'eol':
			//el final
...
function purple($info){
	switch($info['status']){
		case 'start':
		case 'sol':
			//el comienzo de la fuente pintada de rojo
			$this->saveState();
			$this->setColor(0.5,0,0.5);
			$this->setStrokeColor(0.5,0,0.5);
			break;
		case 'end':
		case 'eol':
			//el final
...
function sienna($info){
	switch($info['status']){
		case 'start':
		case 'sol':
			//el comienzo de la fuente pintada de rojo
			$this->saveState();
			$this->setColor(0.625,0.325,0.175);
			$this->setStrokeColor(0.625,0.325,0.175);
			break;
		case 'end':
		case 'eol':
			//el final
...
function salmon($info){
	switch($info['status']){
		case 'start':
		case 'sol':
			//el comienzo de la fuente pintada de rojo
			$this->saveState();
			$this->setColor(1,0.5,0.4);
			$this->setStrokeColor(1,0.5,0.4);
			break;
		case 'end':
		case 'eol':
			//el final
 ...
 * CODIGO DE BARRA
 */
function EAN_13($x,$y,$barcode,$h=45.3543307087,$w=0.992125984252)
...
function Barcode($x,$y,$barcode,$h,$w,$len) {
	...
	//numeracao alinhada central ao codigo
	$start_text = $x + (($last_x - $x) - $font_size*.6*$len) /2;
	//$this->addText($start_text,$y-9,$font_size,substr($barcode,-$len));
	$this->addText($x,$y-7,$font_size,"<b>".substr($barcode,-$len)."</b>");
...
function barCode39($xpos, $ypos, $code, $baseline=0.5, $height=5){
	...
	$this->addText($xpos,$ypos + $height - $height-7,$font_size,'<b>'.$code.'</b>');
	...
	for($i=0; $i<strlen($code); $i++){
		...
		for($bar=0; $bar<9; $bar++){
			...
			if($bar % 2 == 0){
				$this->filledRectangle($xpos,$ypos,$lineWidth,$height);
